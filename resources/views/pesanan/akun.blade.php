...
<section class="min-h-[70vh] bg-[#F2F7FD] py-12 lg:py-16">
        ...
        <div class="mt-8 grid gap-6 lg:grid-cols-3">
            ...
            <div class="flex flex-col items-center rounded-2xl bg-white p-8 text-center shadow-sm ring-1 ring-slate-100">
                ...
                <button
                    type="button"
                    id="btn-foto"
                    class="mt-6 w-full rounded-lg bg-[#0F2A4A] px-4 py-2.5 text-sm font-semibold text-white transition hover:opacity-95">
                    Ubah Foto Profil
                </button>
    ...
    <input
        ...
        disabled
        value="{{ $user['nama'] }}"
        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-700 focus:border-[#1E7BC8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E7BC8]/30 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400">
</div>
...
<div>
    ...
    <div class="relative">
        ...
        <input
            ...
            class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2.5 pr-10 text-sm text-slate-700 focus:border-[#1E7BC8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E7BC8]/30 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400">

        <button
            type="button"
            data-toggle-password
            class="absolute inset-y-0 right-0 flex items-center pr-3 text-slate-400 hover:text-[#1E7BC8]">
...
<div>
    ...
    <textarea
        ...
        data-field
        disabled
        class="w-full rounded-lg border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm text-slate-700 focus:border-[#1E7BC8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#1E7BC8]/30 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400">{{ $user['alamat'] }}</textarea>
</div>
...
<div class="flex flex-wrap gap-3 pt-1">
    ...
    <button
        type="button"
        id="btn-ubah-data"
        class="rounded-lg border border-[#1E7BC8] px-5 py-2.5 text-sm font-semibold text-[#1566AD] transition hover:bg-[#EAF3FC]">
        Ubah Data
    </button>
    ...
    <button
        type="submit"
        id="btn-simpan"
        class="hidden rounded-lg bg-gradient-to-r from-[#2E8BD9] to-[#1566AD] px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-95">
        Simpan Perubahan
    </button>
        ...
        <div class="mt-6 flex justify-end rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
            @if(Route::has('logout'))
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button
                        type="submit"
                        class="inline-flex items-center gap-2 rounded-lg border border-red-200 px-5 py-2.5 text-sm font-semibold text-red-500 transition hover:bg-red-50">
