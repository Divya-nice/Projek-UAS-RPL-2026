...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {{-- Pendapatan Hari Ini --}}
        <div class="rounded-2xl bg-[#EAF3FC] p-5">
            <span class="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-[#1566AD] shadow-sm">
            ...
            <p class="mt-1 text-2xl font-bold text-[#1566AD]">Rp250.000</p>
        </div>
        {{-- Pesanan Hari Ini --}}
        <div class="rounded-2xl bg-[#EAF3FC] p-5">
            <span class="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-[#1566AD] shadow-sm">
            ...
            <p class="mt-1 text-2xl font-bold text-slate-800">8</p>
        </div>
        ...
        <div class="rounded-2xl bg-[#EAF3FC] p-5">
            ...
            <p class="mt-1 text-2xl font-bold text-slate-800">3</p>
        ...
        <div class="rounded-2xl bg-[#EAF3FC] p-5">
            ...
            <p class="mt-1 text-2xl font-bold text-[#1566AD]">Rp7.250.000</p>
            <p class="mt-1 text-[11px] font-semibold tracking-wide text-slate-400">BULAN MEI 2024</p>
        </div>
    </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div class="-mx-5 overflow-x-auto">
            <table class="w-full min-w-[720px] text-left text-sm">
                <thead>
                    <tr class="border-y border-slate-100 text-xs font-semibold uppercase tracking-wide text-slate-400">
                ...
                <tbody class="divide-y divide-slate-100">
                    <tr>
                        ...
                        <td class="px-5 py-4 text-slate-600">Nabila</td>
                        <td class="px-5 py-4 text-slate-600">Deep Cleaning (1 Pasang)</td>
                        <td class="px-5 py-4"><span class="inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700">Menunggu Verifikasi</span></td>
                        <td class="px-5 py-4 text-slate-500">20 Mei 2024<span class="block text-xs text-slate-400">10:30</span></td>
                        <td class="px-5 py-4 text-center">
                            <a href="{{ route('admin.pesanan.detail') }}" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-50">
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-4 text-slate-600">Siti Aisyah</td>
                        <td class="px-5 py-4 text-slate-600">Reguler Cleaning (1 Pasang)</td>
                        <td class="px-5 py-4"><span class="inline-flex rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700">Menunggu Verifikasi</span></td>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-4 text-slate-600">Dimas Putra</td>
                        <td class="px-5 py-4 text-slate-600">Unyellowing (1 Pasang)</td>
                        ...
                        <td class="px-5 py-4 text-slate-500">19 Mei 2024<span class="block text-xs text-slate-400">16:46</span></td>
                        <td class="px-5 py-4 text-center">
                            <a href="{{ route('admin.pesanan.detail') }}" class="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-50">
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.7" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
                                Lihat Detail
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-4 text-slate-600">Nabila Putri</td>
                        <td class="px-5 py-4 text-slate-600">Deep Cleaning (1 Pasang)</td>
                        <td class="px-5 py-4"><span class="inline-flex rounded-full bg-green-100 px-3 py-1 text-xs font-semibold text-green-700">Siap Diambil</span></td>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
            <a href="#" class="flex items-center gap-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 transition hover:shadow-md">
            ...
            <a href="#" class="flex items-center gap-4 rounded-2xl border border-green-200 bg-green-50 p-4 transition hover:shadow-md">
